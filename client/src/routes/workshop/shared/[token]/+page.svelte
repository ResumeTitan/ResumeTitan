<script lang="ts">
    ...
    import { WorkshopHeader, CommentsSidebar } from '$components/workshop';
    ...
    $: currentUser = workshop?.participants.find(p => p.clerkId === $authStore.userId) || {
        ...
        initials: ($authStore.user?.fullName || 'Y')
            .split(' ')
            .map(n => n[0])
            .join('')
            .toUpperCase()
    ...
    {:else if error}
        <div class="max-w-4xl mx-auto p-4">
            ...
            <div class="text-center mt-4">
                <a href="/dashboard" class="text-main-green hover:underline"> Return to Dashboard </a>
            </div>
        </div>
    {:else if resume && workshop}
        ...
        <div class="bg-blue-50 border-b border-blue-200 px-4 py-2">
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <span class="text-xs text-blue-600 bg-blue-100 px-2 py-1 rounded"> View & Comment Only </span>
            </div>
        </div>
        ...
        <div class="workshop-content">
            <div class="workshop-flex">
                ...
                <div class="workshop-editor">
                    <ResumeEditorCore bind:resume readonly={true} showEditor={mode === 'editing'} showPreview={mode === 'preview'} />
                </div>
