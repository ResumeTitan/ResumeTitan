                ...
                {#each resumes as resume (resume._id)}
                    <button
                        ...
                        class="w-full text-left border rounded-lg p-4 transition
							{selectedResumeId === resume._id ? 'border-main-green bg-lightest-green' : 'border-gray-200 hover:border-main-green'}"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="w-5 h-5 rounded-full border flex items-center justify-center
									{selectedResumeId === resume._id ? 'border-main-green bg-main-green' : 'border-gray-300'}"
                            >
