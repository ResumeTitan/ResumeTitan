...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-main-green to-dark-green">
    <div class="text-center text-white p-8">
        <div class="mb-6">
            <svg class="w-24 h-24 mx-auto text-white animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
