...
<svelte:head>
	<title>Privacy Policy - ResumeTitan</title>
</svelte:head>
...
<div class="bg-white min-h-screen">
	...
	<div class="bg-gradient-to-br from-main-green to-dark-green text-white py-16">
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="text-center">
				<h1 class="text-4xl font-bold leading-tight tracking-wide xl:text-5xl mb-6">
					Privacy Policy
				</h1>
				<p class="text-xl text-lightest-green max-w-3xl mx-auto leading-relaxed">
					How we protect your personal information and ensure your privacy while using ResumeTitan's
					services
				</p>
				<div class="mt-6 text-lightest-green">
					<span class="text-sm">Last Updated: October 20, 2024</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
		<div class="bg-white rounded-lg shadow-lg p-8 lg:p-12">
			<div class="prose prose-lg max-w-none">
				<h2 class="text-2xl font-bold text-main-green mb-6">Privacy Policy for ResumeTitan</h2>

				<p class="text-lg text-neutral-600 leading-relaxed mb-6">
					At ResumeTitan, accessible from www.resumetitan.com, one of our main priorities is the
					privacy of our visitors. This Privacy Policy document contains types of information that
					is collected and recorded by ResumeTitan and how we use it.
				</p>
				...
				<div class="space-y-8">
					...
					<div class="bg-lightest-green rounded-lg p-6">
						<h3 class="text-xl font-bold text-main-green mb-4">Log Files</h3>
						<p class="text-neutral-700 leading-relaxed">
							ResumeTitan follows a standard procedure of using log files. These files log visitors
					...
					<!-- Cookies Section -->
					<div class="bg-lightest-green rounded-lg p-6">
						<h3 class="text-xl font-bold text-main-green mb-4">Cookies and Web Beacons</h3>
						<p class="text-neutral-700 leading-relaxed mb-4">
							Like any other website, ResumeTitan uses "cookies". These cookies are used to store
						...
						<p class="text-neutral-700 leading-relaxed">
							...
							<a
								...
								class="text-main-green hover:text-dark-green underline"
							>
					...
					<div class="bg-lightest-green rounded-lg p-6">
						<h3 class="text-xl font-bold text-main-green mb-4">Privacy Policies</h3>
						<p class="text-neutral-700 leading-relaxed mb-4">
							You may consult this list to find the Privacy Policy for each of the advertising
							partners of ResumeTitan.
						</p>
						<p class="text-neutral-700 leading-relaxed mb-4">
							...
							ResumeTitan, which are sent directly to users' browser. They automatically receive
						...
						<p class="text-neutral-700 leading-relaxed">
							Note that ResumeTitan has no access to or control over these cookies that are used by
					...
					<div class="bg-lightest-green rounded-lg p-6">
						<h3 class="text-xl font-bold text-main-green mb-4">Third Party Privacy Policies</h3>
						<p class="text-neutral-700 leading-relaxed mb-4">
							ResumeTitan's Privacy Policy does not apply to other advertisers or websites. Thus, we
					...
					<div class="bg-lightest-green rounded-lg p-6">
						<h3 class="text-xl font-bold text-main-green mb-4">Children's Information</h3>
						<p class="text-neutral-700 leading-relaxed mb-4">
						...
						<p class="text-neutral-700 leading-relaxed">
							ResumeTitan does not knowingly collect any Personal Identifiable Information from
					...
					<div class="bg-lightest-green rounded-lg p-6">
						<h3 class="text-xl font-bold text-main-green mb-4">Online Privacy Policy Only</h3>
						<p class="text-neutral-700 leading-relaxed">
							...
							ResumeTitan. This policy is not applicable to any information collected offline or via
					...
					<!-- Consent Section -->
					<div class="bg-lightest-green rounded-lg p-6">
						<h3 class="text-xl font-bold text-main-green mb-4">Consent</h3>
						<p class="text-neutral-700 leading-relaxed">
	...
	<div class="bg-lightest-green py-16">
		<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
			<h2 class="text-3xl font-bold text-main-green mb-4">Questions About Your Privacy?</h2>
			<p class="text-lg text-neutral-600 mb-8 max-w-2xl mx-auto">
				We're committed to transparency about how we handle your data. If you have any questions
				about our privacy practices, please reach out.
			</p>
