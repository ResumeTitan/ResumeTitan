    ...
    <div class="bg-gradient-to-br from-main-green to-dark-green text-white py-16">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl font-bold leading-tight tracking-wide xl:text-5xl mb-6">Privacy Policy</h1>
                <p class="text-xl text-lightest-green max-w-3xl mx-auto leading-relaxed">
                    How we protect your personal information and ensure your privacy while using ResumeTitan's services
                </p>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 lg:p-12">
            <div class="prose prose-lg max-w-none">
                ...
                <p class="text-lg text-neutral-600 leading-relaxed mb-6">
                    At ResumeTitan, accessible from www.resumetitan.com, one of our main priorities is the privacy of our visitors. This
                    Privacy Policy document contains types of information that is collected and recorded by ResumeTitan and how we use it.
                </p>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-lightest-green rounded-lg p-6">
                        ...
                        <p class="text-neutral-700 leading-relaxed mb-4">
                            ...
                            in their respective advertisements and links that appear on ResumeTitan, which are sent directly to users'
                    ...
                    <div class="bg-lightest-green rounded-lg p-6">
                        ...
                        <p class="text-neutral-700 leading-relaxed mb-4">
                            ResumeTitan's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
                    ...
                    <div class="bg-lightest-green rounded-lg p-6">
                        ...
                        <p class="text-neutral-700 leading-relaxed">
                            ...
                            to the information that they shared and/or collect in ResumeTitan. This policy is not applicable to any
    ...
    <div class="bg-lightest-green py-16">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-neutral-600 mb-8 max-w-2xl mx-auto">
                We're committed to transparency about how we handle your data. If you have any questions about our privacy practices, please
                reach out.
            </p>
