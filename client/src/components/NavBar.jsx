...
const NavBar = () => {
  ...
  return (
    <nav className="flex justify-between w-full items-center bg-main-green py-2 px-8">
      <div className={`flex items-center w-full ${mobileScreen ? "justify-center" : ""}`}>
        <a href="/home" className="font-outline-2 flex font-bold text-xl tracking-tight text-white">
