...
import type { ResumeType, WorkType, EducationType, VolunteerType, ProjectType, SkillType } from '$types';
...
export const resumeApi = {
     ...
     */
    getByUser: (userId: string) => api.get<ResumeListResponse>(`/resume/user?userId=${encodeURIComponent(userId)}`),

    /**
     * Get a single resume by ID
     */
    getById: (id: string) => api.get<ResumeResponse>(`/resume?id=${encodeURIComponent(id)}`),

    /**
     * Create a new resume
     */
    create: (resume: Partial<ResumeType>, jobDescription?: string) => api.post<ResumeType>('/resume/create', { resume, jobDescription }),

    /**
     * Update an existing resume
     */
    update: (resume: ResumeType) => api.put<ResumeResponse>('/resume/update', resume),

    /**
     * Delete a resume
     */
    delete: (id: string) => api.delete(`/resume/delete/${encodeURIComponent(id)}`),
