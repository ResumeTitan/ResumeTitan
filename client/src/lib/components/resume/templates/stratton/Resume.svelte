...
<div class="stratton-resume p-8 font-serif text-[#222]">
    ...
    {#if shouldShowSection('Work') && resume.work && resume.work.length > 0}
        <section class="mb-4">
            <h2 class="text-sm font-bold uppercase tracking-wider border-b border-[#2c3e50] pb-1 mb-2">Professional Experience</h2>
    ...
    {#if shouldShowSection('Education') && resume.education && resume.education.length > 0}
        <section class="mb-4">
            <h2 class="text-sm font-bold uppercase tracking-wider border-b border-[#2c3e50] pb-1 mb-2">Education</h2>
    ...
    {#if shouldShowSection('Skills') && resume.skills && resume.skills.length > 0}
        <section class="mb-4">
            <h2 class="text-sm font-bold uppercase tracking-wider border-b border-[#2c3e50] pb-1 mb-2">Skills</h2>
            <div class="text-xs">
    ...
    {#if shouldShowSection('Projects') && resume.projects && resume.projects.length > 0}
        <section class="mb-4">
            <h2 class="text-sm font-bold uppercase tracking-wider border-b border-[#2c3e50] pb-1 mb-2">Projects</h2>
