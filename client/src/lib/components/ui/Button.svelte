<script lang="ts">
	...
	const variantClasses: Record<ButtonVariant, string> = {
		primary:
			'bg-white text-teal-800 border-black hover:bg-teal-800 hover:text-white',
		secondary:
			'bg-white text-red-700 border-red-500 hover:bg-red-600 hover:text-white hover:border-red-600',
