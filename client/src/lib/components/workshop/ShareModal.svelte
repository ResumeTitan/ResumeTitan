    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div>
                ...
                <p class="text-sm text-gray-500">Allow others to view and comment on this workshop</p>
            </div>
            <button
                type="button"
        ...
        {#if shareEnabled && shareUrl}
            <div class="space-y-2" transition:fly={{ y: -10, duration: 200 }}>
                <label for="share-url" class="block text-sm font-medium text-gray-700"> Share link </label>
                <div class="flex gap-2">
                    ...
                    />
                    <Button variant="primary" size="sm" on:click={copyToClipboard}>
                        {#if copied}
                ...
                <p class="text-xs text-gray-500">Anyone with this link can view your resume and add comments (they must be logged in).</p>
            </div>
        {/if}
        ...
        {#if !shareEnabled}
            <div class="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div class="flex">
                    ...
                    <p class="text-sm text-yellow-700">Sharing is currently disabled. Enable sharing to get a shareable link.</p>
                </div>
            </div>
        {/if}
