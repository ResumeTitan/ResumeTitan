...
<Modal bind:open title="Brainstorm Ideas" size="md" on:close={handleCancel}>
    <div class="space-y-4">
        <p class="text-gray-600">Tell us about your experience, and AI will help generate bullet points for your highlights.</p>

        <div>
            <label for="brainstorm-input" class="form-label-text block mb-2"> Your Experience </label>
            <textarea
                id="brainstorm-input"
                bind:value={input}
                {placeholder}
    ...
    <div slot="footer" class="flex justify-end gap-2">
        <Button variant="ghost" on:click={handleCancel} disabled={loading}>Cancel</Button>
