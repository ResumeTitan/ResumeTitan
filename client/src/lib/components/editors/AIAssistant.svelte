...
<div class="bg-gray-50 border border-gray-200 rounded-lg p-4 mt-4">
    <div class="flex items-center justify-between mb-3">
        ...
        <button type="button" class="text-gray-400 hover:text-gray-600" on:click={() => dispatch('close')} aria-label="Close AI Assistant">
    ...
    <div class="flex justify-end gap-2 mt-3">
        <Button variant="ghost" size="sm" on:click={() => dispatch('close')} disabled={loading}>Cancel</Button>
