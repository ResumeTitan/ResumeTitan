...
<div class="w-full">
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex gap-2">
            <Button variant="ghost" size="sm" on:click={() => dispatch('brainstorm')} {disabled}>Brainstorm</Button>
            <Button variant="ghost" size="sm" on:click={() => dispatch('aiAssist')} {disabled}>AI Assist</Button>
        </div>
    </div>
    ...
    <div class="mt-4">
        <Button variant="ghost" size="sm" on:click={handleAdd} {disabled}>+ Add Highlight</Button>
    </div>
</div>
