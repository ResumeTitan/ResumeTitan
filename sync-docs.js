...
function findNewestFile(fileName) {
    const locations = [path.join(CLIENT_DOCS, fileName), path.join(SERVER_DOCS, fileName)];
...
function syncFile(fileName) {
    ...
    const destinations = [path.join(CLIENT_DOCS, fileName), path.join(SERVER_DOCS, fileName)].filter(dest => dest !== newestFile); // Don't copy to itself
